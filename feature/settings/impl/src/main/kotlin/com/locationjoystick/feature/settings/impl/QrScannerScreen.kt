...
fun QrScannerScreen(
    ...
    if (!cameraPermissionGranted) {
        Column(
            ...
            Text(stringResource(R.string.qr_scanner_camera_permission_required_to_scan_qr))
            LjButton(onClick = onNavigateBack) {
                Text(stringResource(R.string.qr_scanner_back_to_settings))
            }
        }
        return
    }
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        IconButton(
            ...
            Icon(LjIcons.ArrowBack, contentDescription = stringResource(R.string.qr_scanner_back_cd))
        }
    }
}
